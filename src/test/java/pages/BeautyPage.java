...
//    WebElement beautydropdown;
  ...
  //*[@id="category_filter"]/div/ul/li[1]/div/div/label/input
    ...
    public void choose_haircare(WebDriver driver) throws InterruptedException
    {
    	 JavascriptExecutor js = (JavascriptExecutor) driver;
    	
         WebElement element2 = driver.findElement(By.xpath("//*[@id=\"category_filter\"]/div/ul/li[1]/div/div"));
         													//*[@id=\"category_filter\"]/div/ul/li[1]/div/div/label/input
    ...
    {
    	JavascriptExecutor js = (JavascriptExecutor) driver; 
        WebElement element3 = driver.findElement(By.xpath("//*[@id=\"stock_filter\"]/div/ul/li/div/div/div"));
        js.executeScript("arguments[0].scrollIntoView();", element3);
    
        filter_stock.click();
    }
    public void added_cart(WebDriver driver)
    {
        JavascriptExecutor js=(JavascriptExecutor) driver;
